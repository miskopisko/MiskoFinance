...
namespace MiskoFinance.Forms
{
	partial class MiskoFinanceMain
    {
        ...
        private void InitializeComponent()
        {
			...
			this.mMainLayoutTable_.Controls.Add(this.mBottomTable_, 0, 2);
			...
			this.mMainLayoutTable_.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 50F));
			this.mMainLayoutTable_.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 50F));
			...
			this.mTransactionsPanel_.Size = new System.Drawing.Size(1202, 313);
			...
			// mBottomTable_
			// 
			this.mBottomTable_.ColumnCount = 2;
			this.mBottomTable_.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
			this.mBottomTable_.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 100F));
			this.mBottomTable_.Controls.Add(this.mSummaryPanel_, 0, 0);
			this.mBottomTable_.Controls.Add(this.mGraphingPanel_, 1, 0);
			this.mBottomTable_.Dock = System.Windows.Forms.DockStyle.Fill;
			this.mBottomTable_.Location = new System.Drawing.Point(3, 357);
			this.mBottomTable_.Name = "mBottomTable_";
			this.mBottomTable_.RowCount = 1;
			this.mBottomTable_.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 100F));
			this.mBottomTable_.Size = new System.Drawing.Size(1202, 314);
			this.mBottomTable_.TabIndex = 3;
			// 
			// mSummaryPanel_
			// 
			this.mSummaryPanel_.AutoSize = true;
			this.mSummaryPanel_.AutoSizeMode = System.Windows.Forms.AutoSizeMode.GrowAndShrink;
			this.mSummaryPanel_.Location = new System.Drawing.Point(3, 3);
			...
			// mGraphingPanel_
			// 
			this.mGraphingPanel_.Dock = System.Windows.Forms.DockStyle.Fill;
			this.mGraphingPanel_.Location = new System.Drawing.Point(199, 3);
			this.mGraphingPanel_.Name = "mGraphingPanel_";
			this.mGraphingPanel_.Size = new System.Drawing.Size(1000, 308);
			this.mGraphingPanel_.TabIndex = 1;
			// 
			// MiskoFinanceMain
			// 
			...
			this.mBottomTable_.ResumeLayout(false);
			this.mBottomTable_.PerformLayout();
		...
		private System.Windows.Forms.TableLayoutPanel mBottomTable_;
		private Panels.SummaryPanel mSummaryPanel_;
		public Panels.GraphingPanel mGraphingPanel_;
	}
}