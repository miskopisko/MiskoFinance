namespace MiskoFinance.Forms
{
    partial class SettingsDialog
    {
        ...
        private void InitializeComponent()
        {
        	...
        	// mGender_
        	// 
        	this.mGender_.Anchor = System.Windows.Forms.AnchorStyles.Left;
        	...
        	this.mSettingsTableLayoutPanel_.Controls.Add(this.mRowPerPage_, 1, 8);
        	...
        	this.mSettingsTableLayoutPanel_.RowCount = 9;
